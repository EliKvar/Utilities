...
{
    Stone, Fire, Ice, Ricochet
}

public class Tower : MonoBehaviour
{
    public float attackPower = 3f;
    public float timeBetweenAttackInSeconds = 1f;
   ...
   private void SmoothlyLookAtTarget(Vector3 target)
    ...
    public virtual void Update()
    {
        ...
        if(targetEnemy == null)
        {
            ...
            if(GetNearestEnemyInRange()!= null && 
                Vector3.Distance(transform.position, GetNearestEnemyInRange().
        ...
        else
        {
            ...
            {
                AttackEnemy();
                attackCounter = timeBetweenAttackInSeconds;
            }
            if(Vector3.Distance(transform.position, targetEnemy.
                transform.position) > aggroRadius)
            {
                targetEnemy = null;
            }
    ...
    public void LevelUp()
    {
        towerLevel++;
        attackPower *= 2;
        timeBetweenAttackInSeconds *= 0.7f;
        aggroRadius *= 1.20f;
    }
}
